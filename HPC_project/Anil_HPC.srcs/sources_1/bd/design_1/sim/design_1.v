...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [1:0]bit_shift_0_add_out;
  wire [1:0]bit_shift_1_add_out;
  wire [1:0]bit_shift_2_add_out;
  wire [31:0]blk_mem_gen_0_doutb;
  wire [31:0]blk_mem_gen_1_doutb;
  wire [31:0]blk_mem_gen_2_doutb;
  wire [1:0]mmult_0_A_address0;
  wire mmult_0_A_ce0;
  wire [1:0]mmult_0_B_address0;
  wire mmult_0_B_ce0;
  wire [1:0]mmult_0_C_address0;
  wire mmult_0_C_ce0;
  wire [31:0]mmult_0_C_d0;
  wire mmult_0_C_we0;
  ...
  design_1_bit_shift_0_0 bit_shift_0
       (.add_in(axi_bram_ctrl_0_bram_addr_a),
        .add_out(bit_shift_0_add_out));
  design_1_bit_shift_0_1 bit_shift_1
       (.add_in(axi_bram_ctrl_1_bram_addr_a),
        .add_out(bit_shift_1_add_out));
  design_1_bit_shift_1_0 bit_shift_2
       (.add_in(axi_bram_ctrl_2_bram_addr_a),
        .add_out(bit_shift_2_add_out));
  design_1_blk_mem_gen_0_0 blk_mem_gen_0
       (.addra(bit_shift_0_add_out),
        .addrb(mmult_0_A_address0),
  ...
  design_1_blk_mem_gen_0_1 blk_mem_gen_1
       (.addra(bit_shift_1_add_out),
        .addrb(mmult_0_B_address0),
  ...
  design_1_blk_mem_gen_0_2 blk_mem_gen_2
       (.addra(mmult_0_C_address0),
        .addrb(bit_shift_2_add_out),
        .clka(Net),
        ...
        .wea(mmult_0_C_we0));
  design_1_mmult_0_0 mmult_0
       (.A_address0(mmult_0_A_address0),
        .A_ce0(mmult_0_A_ce0),
        .A_q0(blk_mem_gen_0_doutb),
        .B_address0(mmult_0_B_address0),
        .B_ce0(mmult_0_B_ce0),
        .B_q0(blk_mem_gen_1_doutb),
        .C_address0(mmult_0_C_address0),
        .C_ce0(mmult_0_C_ce0),
        .C_d0(mmult_0_C_d0),
        .C_we0(mmult_0_C_we0),
        .ap_clk(Net),
